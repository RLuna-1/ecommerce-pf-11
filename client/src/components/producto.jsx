  ...
  return (
    ...
    <div className="w-full max-w-sm bg-#1F2937 border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
        ...
        <div className="px-5 pb-5">
          ...
          <h5 className="text-xl font-semibold tracking-tight text-gray-900 dark:text-white">Categoria: {product.categories[0].name}</h5>
          </div>
          {/* <div className="flex items-center mt-2.5 mb-5">
        ...
        <div className="flex items-center justify-between">
            ...
            <a href="#" onClick={() => addToCart(product.id)} className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Add to cart</a>
        </div>

...
function FilterByCategorie() {
  ...
  const handleOptionChange = (e) => {
	...
	setSelectedCategories((prevSelectedCategories) => {
	  ...
	  if (isChecked) {
		updatedCategories = prevSelectedCategories ? [...prevSelectedCategories, selectedCategory] : [selectedCategory];
	  } else {
		updatedCategories = prevSelectedCategories ? prevSelectedCategories.filter(
      ...
      <div className='option'>
        ...
        <div className='suboptions'>
          ...
          <label>
            <input
              type='checkbox'
              checked={selectedCategories.includes('Arte Digital')}
              value='Arte Digital'
              onChange={handleOptionChange}
            />
            Arte Digital
          ...
          <label>
            <input
              type='checkbox'
              checked={selectedCategories.includes('Redes y servidores')}
              value='Redes y servidores'
              onChange={handleOptionChange}
            />
            Redes y servidores
          </label>
		  <label>
					<input
							type='checkbox'
							checked={selectedCategories.includes('Antivirus')}
							value='Antivirus'
							onChange={handleOptionChange}
						/>
						Antivirus

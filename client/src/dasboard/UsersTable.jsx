...
import { addUser, deleteUser, editUser, getUsers } from "../redux/actions/actions";
        ...
        <tbody>
          {filteredUsers.map((user) => (
            <tr key={user.id}>
              ...
              <td className="p-2 border">{user.admin === true ? (<p className="text-gray-600 font-semibold text-center">SI</p>)  : <p className="text-red-700 text-base font-semibold text-center">NO</p>}</td>
              <td className="p-2 border">{user.is_verified === true ? (<p className="text-gray-600 text-center">Verificado</p>)  : <p className="text-gray-600 font-semibold">NO</p>}</td>
              <td className="p-2 border">{user.disabled === true ? (<p className="text-red-700 text-base font-semibold ">SI</p>)  : <p className="text-gray-600 font-semibold">NO</p>}</td>
      ...
      {deleteModalOpen && (
        <div className="fixed top-0 left-0 w-full h-full flex items-center justify-center bg-black bg-opacity-50">
          <div className="bg-white p-4 rounded">
             {selectedProduct.disabled ? <div> <h2 className="text-lg font-bold mb-2">{`Habilitar Usuario `}</h2>
            ...
            <div> <h2 className="text-lg font-bold mb-2">{`Deshabilitar Usuario `}</h2>
